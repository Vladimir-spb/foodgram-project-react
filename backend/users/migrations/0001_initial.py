    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'user'), ('admin', 'admin')], default='user', max_length=25, verbose_name='role')),
                ('blocked', models.CharField(choices=[('b', 'Block'), ('u', 'Unblock')], default='u', max_length=10, verbose_name='Блокировка')),
